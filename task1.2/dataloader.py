#Our dataset used to train the model
            ...
            for camera_folder in os.listdir(scene_path):
                ...
                for obj_folder in os.listdir(camera_path):
                    ...
                    try:
                        ...
                        continue
                    # Get amodal rgba files
                    amodal_files = glob.glob(os.path.join(obj_path, 'rgba_*.png'))
                    amodal_files.sort()
                    ...
                    for rgba_file in rgba_files:
                        ...
                        amodal_file = os.path.join(obj_path, f'rgba_{frame_name}.png')
